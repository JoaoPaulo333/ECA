...
CREATE TABLE `tb_fisherman_insurance` (
  `idtb_fisherman_insurance` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tb_guarantee_crop`
--

DROP TABLE IF EXISTS `tb_guarantee_crop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_guarantee_crop` (
  `idtb_guarantee_crop` int(11) NOT NULL AUTO_INCREMENT,
  `str_year` varchar(4) NOT NULL,
  `str_month` varchar(2) NOT NULL,
  `db_value` double NOT NULL,
  `tb_city_id_city` int(11) NOT NULL,
  `tb_beneficiaries_id_beneficiaries` bigint(20) NOT NULL,
  PRIMARY KEY (`idtb_guarantee_crop`),
  KEY `fk_tb_guarantee_crop_tb_city1_idx` (`tb_city_id_city`),
  KEY `fk_tb_guarantee_crop_tb_beneficiaries1_idx` (`tb_beneficiaries_id_beneficiaries`),
  CONSTRAINT `fk_tb_guarantee_crop_tb_beneficiaries1` FOREIGN KEY (`tb_beneficiaries_id_beneficiaries`) REFERENCES `tb_beneficiaries` (`id_beneficiaries`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_guarantee_crop_tb_city1` FOREIGN KEY (`tb_city_id_city`) REFERENCES `tb_city` (`id_city`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_guarantee_crop`
--

LOCK TABLES `tb_guarantee_crop` WRITE;
/*!40000 ALTER TABLE `tb_guarantee_crop` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_guarantee_crop` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_peti` (
  `idtb_peti` int(11) NOT NULL AUTO_INCREMENT,
  `str_year` varchar(4) NOT NULL,
  `str_month` varchar(2) NOT NULL,
...
-- Dump completed on 2018-09-06 22:00:09
